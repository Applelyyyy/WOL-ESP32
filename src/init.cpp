...
const char* ssid     = "Apple_2.4G";      // Change to your WiFi name
const char* password = "25242378";  // Change to your WiFi password

const char* serverName = "WOL-Server";        // Change to your server name
const char *MACAddress = "c4:65:16:36:9a:5a"; // Change to your PC's MAC address
IPAddress pc_ip(192, 168, 1, 48);                  // Change to your PC's IP address Ex. IPAddress pc_ip(10, 10, 1, 11); 
